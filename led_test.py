#To Fix:
#When you hold in front of a laser
#it swaps between the current state 
#and the starting state. we need a 
#pass when a laser is being blocked
#but when i added one it stoped the
#whole system, we must implement this
#different.
...
#leds
red_led = OutputDevice(16)
green_led = OutputDevice(12)
...
#laser 1 tripped first 
def buffer_one_state(laser1, laser2):
    #print(laser1, laser2)
    print("bugger_one_state")
    if laser1 and not laser2:
        new_state = 'start'
    elif laser2 and not laser1:
        new_state = 'entered'
...
#laser 2 tripped first
def buffer_two_state(laser1, laser2):
    #print(laser1, laser2)
    print("buffer_two_state")
    if laser1 and not laser2:
        new_state = 'exited'
    elif laser2 and not laser1:
        new_state = 'start'
